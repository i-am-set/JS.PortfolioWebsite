...
export default async function initPdfViewer() {
    ...
    requestAnimationFrame(() => {
        ...
        container.innerHTML = `
            <div class="relative w-full h-full min-h-[300px] flex flex-col items-center justify-center bg-surface rounded-xl overflow-hidden border border-secondary/30 group gpu-accel">
                <img src="./assets/images/resume-preview.jpg" alt="Resume Preview" loading="lazy" class="w-full h-full object-cover opacity-30 group-hover:opacity-40 transition-opacity duration-300" onerror="this.src='${FALLBACK_IMG}'">
                <div class="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <a href="${PDF_URL}" target="_blank" rel="noopener noreferrer" class="bg-primary hover:bg-accent text-background hover:text-surface px-6 py-2 rounded-lg font-medium transition-colors duration-200 shadow-lg flex items-center gap-2 gpu-accel">
                        <span>Open PDF</span>
