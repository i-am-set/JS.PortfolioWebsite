    ...
    experienceData.forEach(job => {
        ...
        const jobHtml = `
            <div class="relative group">
                <!-- Timeline Dot -->
                <div class="absolute -left-[41px] top-1.5 h-4 w-4 rounded-full bg-surface border-2 border-primary group-hover:bg-primary transition-colors duration-300"></div>
